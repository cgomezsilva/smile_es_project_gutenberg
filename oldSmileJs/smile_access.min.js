...
!function(e, t) {
    ...
    function r(e, n, i, r) {
        if (lt.acceptData(e)) {
            var o, s, a = lt.expando, l = "string" == typeof n, u = e.nodeType, c = u ? lt.cache : e, f = u ? e[a] : e[a] && a;
            if (f && c[f] && (r || c[f].data) || !l || i !== t)
                return f || (u ? e[a] = f = Z.pop() || lt.guid++ : f = a),
                c[f] || (c[f] = {},
                u || (c[f].toJSON = lt.noop)),
                ("object" == typeof n || "function" == typeof n) && (r ? c[f] = lt.extend(c[f], n) : c[f].data = lt.extend(c[f].data, n)),
                o = c[f],
                r || (o.data || (o.data = {}),
                o = o.data),
    ...
    function T(e, t) {
        for (var n, i, r, o = [], s = 0, a = e.length; a > s; s++)
            ...
            "" === i.style.display && k(i) && (o[s] = lt._data(i, "olddisplay", E(i.nodeName)))) : o[s] || (r = k(i),
    ...
    function A(e, t, n, i) {
        ...
        if (lt.isArray(t))
            lt.each(t, function(t, r) {
                n || En.test(e) ? i(e, r) : A(e + "[" + ("object" == typeof r ? t : "") + "]", r, n, i)
            });
    ...
    function P(e, t, n) {
        var i, r, o, s, a, l, u, c, f, h = this, p = e.style, d = {}, g = [], m = e.nodeType && k(e);
        ...
        "inline" === lt.css(e, "display") && "none" === lt.css(e, "float") && (lt.support.inlineBlockNeedsLayout && "inline" !== E(e.nodeName) ? p.zoom = 1 : p.display = "inline-block")),
    ...
    var W, U, X = typeof t, J = e.document, Q = e.location, Y = e.jQuery, G = e.$, K = {}, Z = [], et = "1.9.1", tt = Z.concat, nt = Z.push, it = Z.slice, rt = Z.indexOf, ot = K.toString, st = K.hasOwnProperty, at = et.trim, lt = function(e, t) {
        return new lt.fn.init(e,t,U)
    }
    , ut = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, ct = /\S+/g, ft = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, ht = /^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/, pt = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, dt = /^[\],:{}\s]*$/, gt = /(?:^|:|,)(?:\s*\[)+/g, mt = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g, vt = /"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g, yt = /^-ms-/, bt = /-([\da-z])/gi, xt = function(e, t) {
        ...
        init: function(e, n, i) {
            ...
            if ("string" == typeof e) {
                ...
                if (r[1]) {
                    ...
                    pt.test(r[1]) && lt.isPlainObject(n))
                        for (r in n)
    ...
    lt.Callbacks = function(e) {
        ...
        var n, r, o, s, a, l, u = [], c = !e.once && [], f = function(t) {
            for (r = e.memory && t,
            o = !0,
            a = l || 0,
            l = 0,
            ...
            n = !1,
            u && (c ? c.length && f(c.shift()) : r ? u = [] : h.disable())
        }
        , h = {
            add: function() {
                if (u) {
    ...
    lt.support = function() {
        var t, n, i, r, o, s, a, l, u, c, f = J.createElement("div");
    ...
    lt.extend({
        ...
        attr: function(e, n, i) {
            ...
            if (e && 3 !== a && 8 !== a && 2 !== a)
                ...
                o && (n = n.toLowerCase(),
                r = lt.attrHooks[n] || ($t.test(n) ? Et : Nt)),
    ...
    Mt && Dt || (lt.attrHooks.value = {
        ...
        set: function(e, t, n) {
            ...
            void 0) : Nt && Nt.set(e, t, n)
        }
    }),
    Dt || (Nt = lt.valHooks.button = {
        get: function(e, n) {
            var i = e.getAttributeNode(n);
    ...
    lt.event = {
        ...
        add: function(e, n, i, r, o) {
            var s, a, l, u, c, f, h, p, d, g, m, v = lt._data(e);
            if (v) {
                for (i.handler && (u = i,
                i = u.handler,
                o = u.selector),
                ...
                l = n.length; l--; )
                    ...
                    (p = a[d]) || (p = a[d] = [],
                    p.delegateCount = 0,
                    c.setup && c.setup.call(e, r, g, f) !== !1 || (e.addEventListener ? e.addEventListener(d, f, !1) : e.attachEvent && e.attachEvent("on" + d, f))),
        ...
        remove: function(e, t, n, i, r) {
            var o, s, a, l, u, c, f, h, p, d, g, m = lt.hasData(e) && lt._data(e);
            if (m && (c = m.events)) {
                for (t = (t || "").match(ct) || [""],
                u = t.length; u--; )
                    if (a = Bt.exec(t[u]) || [],
                    ...
                    p) {
                        ...
                        l && !h.length && (f.teardown && f.teardown.call(e, d, m.handle) !== !1 || lt.removeEvent(e, p, m.handle),
                        delete c[p])
                    } else
                        for (p in c)
                            lt.event.remove(e, p + t[u], n, i, !0);
                lt.isEmptyObject(c) && (delete m.handle,
                lt._removeData(e, "events"))
            }
        },
        trigger: function(n, i, r, o) {
            var s, a, l, u, c, f, h, p = [r || J], d = st.call(n, "type") ? n.type : n, g = st.call(n, "namespace") ? n.namespace.split(".") : [];
            if (l = f = r = r || J,
            3 !== r.nodeType && 8 !== r.nodeType && !Ft.test(d + lt.event.triggered) && (d.indexOf(".") >= 0 && (g = d.split("."),
            d = g.shift(),
            g.sort()),
            a = d.indexOf(":") < 0 && "on" + d,
            ...
            o || !c.trigger || c.trigger.apply(r, i) !== !1)) {
                if (!o && !c.noBubble && !lt.isWindow(r)) {
                    ...
                    Ft.test(u + d) || (l = l.parentNode); l; l = l.parentNode)
                        p.push(l),
                        f = l;
                    f === (r.ownerDocument || J) && p.push(f.defaultView || f.parentWindow || e)
                }
    ...
    function(e, t) {
        ...
        function s(e, t, n, i) {
            var r, o, s, a, l, u, c, p, d, g;
            if ((t ? t.ownerDocument || t : B) !== L && j(t),
            t = t || L,
            n = n || [],
            !e || "string" != typeof e)
                return n;
            ...
            if (!H && !i) {
                if (r = gt.exec(e))
                    if (s = r[1]) {
                        ...
                        if (r[2])
                            return G.apply(n, K.call(t.getElementsByTagName(e), 0)),
                            n;
                        if ((s = r[3]) && P.getByClassName && t.getElementsByClassName)
                            return G.apply(n, K.call(t.getElementsByClassName(s), 0)),
                            n
                    }
                if (P.qsa && !D.test(e)) {
                    if (c = !0,
                    ...
                    1 === a && "object" !== t.nodeName.toLowerCase()) {
                        for (u = f(e),
                        (c = t.getAttribute("id")) ? p = c.replace(yt, "\\$&") : t.setAttribute("id", p),
                        p = "[id='" + p + "'] ",
                        l = u.length; l--; )
                            u[l] = p + h(u[l]);
                    ...
                    if (g)
                        try {
                            return G.apply(n, K.call(d.querySelectorAll(g), 0)),
                            n
                        } catch (m) {} finally {
        ...
        function m(e, t, n, i, o, s) {
            ...
            o && !o[F] && (o = m(o, s)),
            r(function(r, s, a, l) {
                var u, c, f, h = [], p = [], d = s.length, m = r || b(t || "*", a.nodeType ? [a] : a, []), v = !e || !r && t ? m : g(m, h, e, a, l), y = n ? o || (r ? e : d || i) ? [] : s : v;
                if (n && n(v, y, a, l),
                i)
                    for (u = g(y, p),
                    i(u, [], a, l),
                ...
                if (r) {
                    if (o || e) {
                        ...
                        for (c = y.length; c--; )
                            (f = y[c]) && (u = o ? Z.call(r, f) : h[c]) > -1 && (r[u] = !(s[u] = f))
                    }
                } else
                    y = g(y === s ? y.splice(d, y.length) : y),
                    o ? o(null , s, y, l) : G.apply(s, y)
            })
        }
        function v(e) {
            for (var t, n, i, r = e.length, o = _.relative[e[0].type], s = o || _.relative[" "], a = o ? 1 : 0, l = p(function(e) {
                return e === t
            }, s, !0), u = p(function(e) {
                return Z.call(t, e) > -1
        ...
        function y(e, t) {
            var n = 0
              ...
              , a = function(r, a, l, u, c) {
                var f, h, p, d = [], m = 0, v = "0", y = r && [], b = null != c, x = A, w = r || o && _.find.TAG("*", c && a.parentNode || a), k = I += null == x ? 1 : Math.random() || .1;
                for (b && (A = a !== L && a,
                T = n); null != (f = w[v]); v++) {
                    if (o && f) {
                        for (h = 0; p = e[h++]; )
        ...
        function x(e, t, n, i) {
            ...
            if (!i && 1 === u.length) {
                ...
                !_.relative[a = s.type]); )
                    if ((l = _.find[a]) && (i = l(s.matches[0].replace(xt, wt), pt.test(o[0].type) && t.parentNode || t))) {
                        if (o.splice(r, 1),
                        e = i.length && h(o),
                        !e)
                            return G.apply(n, K.call(i, 0)),
                            n;
                        break
                    }
            }
            return E(e, u)(i, t, H, n, pt.test(e)),
            n
        }
        function w() {}
        var k, T, _, C, N, E, S, A, j, L, $, H, D, M, O, q, R, F = "sizzle" + -new Date, B = e.document, P = {}, I = 0, V = 0, z = i(), W = i(), U = i(), X = typeof t, J = 1 << 31, Q = [], Y = Q.pop, G = Q.push, K = Q.slice, Z = Q.indexOf || function(e) {
            for (var t = 0, n = this.length; n > t; t++)
                if (this[t] === e)
                    return t;
            return -1
        }
        , et = "[\\x20\\t\\r\\n\\f]", tt = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", nt = tt.replace("w", "w#"), it = "([*^$|!~]?=)", rt = "\\[" + et + "*(" + tt + ")" + et + "*(?:" + it + et + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + nt + ")|)|)" + et + "*\\]", ot = ":(" + tt + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + rt.replace(3, 8) + ")*)|.*)\\)|)", st = new RegExp("^" + et + "+|((?:^|[^\\\\])(?:\\\\.)*)" + et + "+$","g"), at = new RegExp("^" + et + "*," + et + "*"), ut = new RegExp("^" + et + "*([\\x20\\t\\r\\n\\f>+~])" + et + "*"), ct = new RegExp(ot), ft = new RegExp("^" + nt + "$"), ht = {
            ID: new RegExp("^#(" + tt + ")"),
            CLASS: new RegExp("^\\.(" + tt + ")"),
        ...
        j = s.setDocument = function(e) {
            ...
            P.getByName = o(function(e) {
                ...
                return P.getIdNotName = !i.getElementById(F),
                $.removeChild(e),
                t
            }),
            ...
            R = $.compareDocumentPosition ? function(e, t) {
                var n;
                return e === t ? (S = !0,
                0) : (n = t.compareDocumentPosition && e.compareDocumentPosition && e.compareDocumentPosition(t)) ? 1 & n || e.parentNode && 11 === e.parentNode.nodeType ? e === i || q(B, e) ? -1 : t === i || q(B, t) ? 1 : 0 : 4 & n ? -1 : 1 : e.compareDocumentPosition ? -1 : 1
            }
            : function(e, t) {
        ...
        _ = s.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[5] && e[2];
                    return ht.CHILD.test(e[0]) ? null : (e[4] ? e[2] = e[4] : n && ct.test(n) && (t = f(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(e, t, n, i, r) {
                    ...
                    : function(t, n, l) {
                        var u, c, f, h, p, d, g = o !== s ? "nextSibling" : "previousSibling", m = t.parentNode, v = a && t.nodeName.toLowerCase(), y = !l && !a;
                        if (m) {
                            if (o) {
                                for (; g; ) {
                                    for (f = t; f = f[g]; )
                            ...
                            } else if (y && (u = (t[F] || (t[F] = {}))[e]) && u[0] === I)
                                h = u[1];
                            else
                                for (; (f = ++p && f && f[g] || (h = p = 0) || d.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++h || (y && ((f[F] || (f[F] = {}))[e] = [I, h]),
                                f !== t)); )
                                    ;
                            return h -= r,
                            h === i || 0 === h % i && h / i >= 0
                ...
                PSEUDO: function(e, t) {
                    ...
                    return i[F] ? i(t) : i.length > 1 ? (n = [e, e, "", t],
    ...
    lt.fn.extend({
        ...
        html: function(e) {
            return lt.access(this, function(e) {
                ...
                if (!("string" != typeof e || en.test(e) || !lt.support.htmlSerialize && Jt.test(e) || !lt.support.leadingWhitespace && Qt.test(e) || an[(Gt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(Yt, "<$1></$2>");
                    try {
                        for (; r > i; i++)
                            n = this[i] || {},
        ...
        domManip: function(e, n, i) {
            e = tt.apply([], e);
            var r, o, s, a, l, u, c = 0, f = this.length, h = this, m = f - 1, v = e[0], y = lt.isFunction(v);
            if (y || !(1 >= f || "string" != typeof v || lt.support.checkClone) && nn.test(v))
                return this.each(function(r) {
                    var o = h.eq(r);
                    y && (e[0] = v.call(this, r, n ? o.html() : t)),
                    o.domManip(e, n, i)
                });
            if (f && (u = lt.buildFragment(e, this[0].ownerDocument, !1, this),
            r = u.firstChild,
            ...
            r)) {
                ...
                s = a.length; f > c; c++)
                    ...
                    i.call(n && lt.nodeName(this[c], "table") ? p(this[c], "tbody") : this[c], o, c);
                if (s)
    ...
    lt.extend({
        ...
        buildFragment: function(e, t, n, i) {
            for (var r, o, s, a, l, u, c, f = e.length, p = h(t), d = [], g = 0; f > g; g++)
                if (o = e[g],
                o || 0 === o)
                    if ("object" === lt.type(o))
                        ...
                        l = (Gt.exec(o) || ["", ""])[1].toLowerCase(),
                        c = an[l] || an._default,
                        a.innerHTML = c[1] + o.replace(Yt, "<$1></$2>") + c[2],
                        r = c[0]; r--; )
                            a = a.lastChild;
                        if (!lt.support.leadingWhitespace && Qt.test(o) && d.push(t.createTextNode(Qt.exec(o)[0])),
                        !lt.support.tbody)
    ...
    var cn, fn, hn, pn = /alpha\([^)]*\)/i, dn = /opacity\s*=\s*([^)]*)/, gn = /^(top|right|bottom|left)$/, mn = /^(none|table(?!-c[ea]).+)/, vn = /^margin/, yn = new RegExp("^(" + ut + ")(.*)$","i"), bn = new RegExp("^(" + ut + ")(?!px)[a-z%]+$","i"), xn = new RegExp("^([+-])=(" + ut + ")","i"), wn = {
        BODY: "block"
    }, kn = {
        position: "absolute",
        visibility: "hidden",
    ...
    ,
    hn = function(e, n, i) {
        var r, o, s, a = i || fn(e), l = a ? a.getPropertyValue(n) || a[n] : t, u = e.style;
    ...
    ,
    hn = function(e, n, i) {
        var r, o, s, a = i || fn(e), l = a ? a[n] : t, u = e.style;
    ...
    lt.support.opacity || (lt.cssHooks.opacity = {
        ...
        set: function(e, t) {
            ...
            n.zoom = 1,
            (t >= 1 || "" === t) && "" === lt.trim(o.replace(pn, "")) && n.removeAttribute && (n.removeAttribute("filter"),
    ...
    ;
    var Ln, $n, Hn = lt.now(), Dn = /\?/, Mn = /#.*$/, On = /([?&])_=[^&]*/, qn = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Rn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Fn = /^(?:GET|HEAD)$/, Bn = /^\/\//, Pn = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, In = lt.fn.load, Vn = {}, zn = {}, Wn = "*/".concat("*");
    try {
        $n = Q.href
    } catch (Un) {
        $n = J.createElement("a"),
    ...
    lt.extend({
        ...
        ajax: function(e, n) {
            function i(e, n, i, r) {
                ...
                k.status = e,
                k.statusText = (n || T) + "",
                o ? g.resolveWith(p, [f, T, k]) : g.rejectWith(p, [k, T, y]),
                k.statusCode(v),
                v = t,
                u && d.trigger(o ? "ajaxSuccess" : "ajaxError", [k, h, o ? f : y]),
                m.fireWith(p, [k, T]),
            ...
            e = t),
            n = n || {};
            var r, o, s, a, l, u, c, f, h = lt.ajaxSetup({}, n), p = h.context || h, d = h.context && (p.nodeType || p.jquery) ? lt(p) : lt.event, g = lt.Deferred(), m = lt.Callbacks("once memory"), v = h.statusCode || {}, y = {}, b = {}, x = 0, w = "canceled", k = {
                readyState: 0,
            ...
            k.success = k.done,
            k.error = k.fail,
            h.url = ((e || h.url || $n) + "").replace(Mn, "").replace(Bn, Ln[1] + "//"),
    ...
    : M,
    Yn = lt.ajaxSettings.xhr(),
    lt.support.cors = !!Yn && "withCredentials"in Yn,
    Yn = lt.support.ajax = !!Yn,
    Yn && lt.ajaxTransport(function(n) {
        if (!n.crossDomain || lt.support.cors) {
            ...
            return {
                send: function(r, o) {
                    ...
                    ,
                    n.async ? 4 === l.readyState ? setTimeout(i) : (s = ++Gn,
                    Kn && (Qn || (Qn = {},
                    lt(e).unload(Kn)),
                    Qn[s] = i),
    ...
    lt.offset = {
        setOffset: function(e, t, n) {
            ...
            var r, o, s = lt(e), a = s.offset(), l = lt.css(e, "top"), u = lt.css(e, "left"), c = ("absolute" === i || "fixed" === i) && lt.inArray("auto", [l, u]) > -1, f = {}, h = {};
            c ? (h = s.position(),
            r = h.top,
...
function() {
    ...
    ;
    var N = T.some = T.any = function(e, t, i) {
        t || (t = T.identity);
        var r = !1;
    ...
    T.contains = T.include = function(e, t) {
        return null == e ? !1 : y && e.indexOf === y ? -1 != e.indexOf(t) : N(e, function(e) {
            return e === t
        })
    }
    ,
...
function() {
    ...
    a.extend(m.prototype, l, {
        ...
        set: function(e, t) {
            ...
            a.isArray(e) || (e = e ? [e] : []);
            var n, i, o, l, u, c = t.at, f = this.comparator && null == c && t.sort !== !1, h = a.isString(this.comparator) ? this.comparator : null , p = [], d = [], g = {};
            for (n = 0,
            i = e.length; i > n; n++)
                (o = this._prepareModel(e[n], t)) && ((l = this.get(o)) ? (t.remove && (g[l.cid] = !0),
                t.merge && (l.set(o.attributes, t),
                f && !u && l.hasChanged(h) && (u = !0))) : t.add && (p.push(o),
            ...
            null != c ? s.apply(this.models, [c, 0].concat(p)) : r.apply(this.models, p)),
            u && this.sort({
                silent: !0
            }),
            t.silent)
    ...
    ;
    p.extend = m.extend = C.extend = w.extend = j.extend = M;
    var O = function() {
...
function() {
    ...
    e.prototype.token = function(e, t) {
        for (var n, i, r, o, s, a, u, c, f, e = e.replace(/^ +$/gm, ""); e; )
            ...
            r = this.rules.code.exec(e))
                ...
                c = 0; f > c; c++)
                    ...
                    this.options.smartLists && c !== f - 1 && (s = l.bullet.exec(r[c + 1])[0],
...
function(e) {
    ...
    e.HomeView = e.View.extend({
        ...
        buttonPress: function(t) {
            var n = t.target.getAttribute("data-app-id");
            "smile" == n ? (logger.info("navigating to app smile"),
            e.showLoadingModal({
                text: "Loading SMILE at " + window.location.origin + "/smile"
            }),
            window.location = "/smile") : "wikipedia" == n ? (logger.info("navigating to wikipeda"),
            window.location = window.location.origin + "/wikipedia_buscar/") : "khan" == n ? (logger.info("navigating to khan"),
            window.location = window.location.origin + ":8008") : "bible" == n ? (logger.info("navigating to bible"),
            window.location = window.location.origin + "/bible_es/") : "bibleforchildren" == n ? (logger.info("navigating to bibleforchildren"),
            window.location = window.location.origin + "/bible_for_children_es/") : "gutenberg" == n ? (logger.info("navigating to gutenberg"),
            window.location = window.location.origin + "/gutenberg/") : "paint" == n && (logger.info("navigating to paint"),
            window.location = window.location.origin + "/paint_es/")
        },
        render: function() {
            return this.$el.html(this.template({
                showWelcomeMsg: t,
