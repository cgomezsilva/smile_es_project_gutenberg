...
!function(e, t) {
    ...
    function r(e, n, i, r) {
        if (lt.acceptData(e)) {
            var o, s, a = lt.expando, l = "string" == typeof n, u = e.nodeType, c = u ? lt.cache : e, p = u ? e[a] : e[a] && a;
            if (p && c[p] && (r || c[p].data) || !l || i !== t)
                return p || (u ? e[a] = p = Z.pop() || lt.guid++ : p = a),
                c[p] || (c[p] = {},
                u || (c[p].toJSON = lt.noop)),
                ("object" == typeof n || "function" == typeof n) && (r ? c[p] = lt.extend(c[p], n) : c[p].data = lt.extend(c[p].data, n)),
                o = c[p],
                r || (o.data || (o.data = {}),
                o = o.data),
                i !== t && (o[lt.camelCase(n)] = i),
                l ? (s = o[n],
                null == s && (s = o[lt.camelCase(n)])) : s = o,
                s
        }
    }
    function o(e, t, n) {
        if (lt.acceptData(e)) {
            var i, r, o, s = e.nodeType, l = s ? lt.cache : e, u = s ? e[lt.expando] : lt.expando;
            if (l[u]) {
                if (t && (o = n ? l[u] : l[u].data)) {
                    lt.isArray(t) ? t = t.concat(lt.map(t, lt.camelCase)) : t in o ? t = [t] : (t = lt.camelCase(t),
                    t = t in o ? [t] : t.split(" "));
                    for (i = 0,
                    r = t.length; r > i; i++)
                        delete o[t[i]];
                    if (!(n ? a : lt.isEmptyObject)(o))
                        return
                }
                (n || (delete l[u].data,
                a(l[u]))) && (s ? lt.cleanData([e], !0) : lt.support.deleteExpando || l != l.window ? delete l[u] : l[u] = null )
            }
        }
    }
    function s(e, n, i) {
        if (i === t && 1 === e.nodeType) {
            ...
            "string" == typeof i) {
                try {
                    i = "true" === i ? !0 : "false" === i ? !1 : "null" === i ? null : +i + "" === i ? +i : _t.test(i) ? lt.parseJSON(i) : i
                } catch (o) {}
                lt.data(e, n, i)
            } else
                i = t
    ...
    function v(e, t) {
        if (1 === t.nodeType && lt.hasData(e)) {
            var n, i, r, o = lt._data(e), s = lt._data(t, o), a = o.events;
            if (a) {
                delete s.handle,
                s.events = {};
                for (n in a)
    ...
    function b(e, n) {
        var i, r, o = 0, s = typeof e.getElementsByTagName !== X ? e.getElementsByTagName(n || "*") : typeof e.querySelectorAll !== X ? e.querySelectorAll(n || "*") : t;
        if (!s)
            for (s = [],
            i = e.childNodes || e; null != (r = i[o]); o++)
                !n || lt.nodeName(r, n) ? s.push(r) : lt.merge(s, b(r, n));
    ...
    function T(e, t) {
        for (var n, i, r, o = [], s = 0, a = e.length; a > s; s++)
            i = e[s],
            i.style && (o[s] = lt._data(i, "olddisplay"),
            n = i.style.display,
            t ? (o[s] || "none" !== n || (i.style.display = ""),
            "" === i.style.display && k(i) && (o[s] = lt._data(i, "olddisplay", N(i.nodeName)))) : o[s] || (r = k(i),
    ...
    function C(e, t, n, i, r) {
        for (var o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2)
            "margin" === n && (s += lt.css(e, n + _n[o], !0, r)),
            i ? ("content" === n && (s -= lt.css(e, "padding" + _n[o], !0, r)),
            "margin" !== n && (s -= lt.css(e, "border" + _n[o] + "Width", !0, r))) : (s += lt.css(e, "padding" + _n[o], !0, r),
            "padding" !== n && (s += lt.css(e, "border" + _n[o] + "Width", !0, r)));
        return s
    }
    function E(e, t, n) {
        var i = !0
        ...
        if (0 >= r || null == r) {
            ...
            bn.test(r))
                return r;
            i = s && (lt.support.boxSizingReliable || r === e.style[t]),
            r = parseFloat(r) || 0
        }
    ...
    function N(e) {
        var t = J
          , n = wn[e];
        return n || (n = S(e, t),
        "none" !== n && n || (cn = (cn || lt("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement),
    ...
    function j(e) {
        return function(t, n) {
            "string" != typeof t && (n = t,
            t = "*");
            var i, r = 0, o = t.toLowerCase().match(ct) || [];
            if (lt.isFunction(n))
                for (; i = o[r++]; )
                    "+" === i[0] ? (i = i.slice(1) || "*",
    ...
    function D(e, t) {
        var n, i, r, o, s = {}, a = 0, l = e.dataTypes.slice(), u = l[0];
    ...
    function B(e, t, n) {
        var i, r, o = 0, s = ri.length, a = lt.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (r)
                return !1;
            for (var t = Zn || q(), n = Math.max(0, u.startTime + u.duration - t), i = n / u.duration || 0, o = 1 - i, s = 0, l = u.tweens.length; l > s; s++)
                u.tweens[s].run(o);
    ...
    function P(e, t, n) {
        var i, r, o, s, a, l, u, c, p, h = this, f = e.style, d = {}, g = [], m = e.nodeType && k(e);
        n.queue || (c = lt._queueHooks(e, "fx"),
        ...
        "inline" === lt.css(e, "display") && "none" === lt.css(e, "float") && (lt.support.inlineBlockNeedsLayout && "inline" !== N(e.nodeName) ? f.zoom = 1 : f.display = "inline-block")),
        ...
        if (o = g.length) {
            a = lt._data(e, "fxshow") || lt._data(e, "fxshow", {}),
            "hidden"in a && (m = a.hidden),
            l && (a.hidden = !m),
            m ? lt(e).show() : h.done(function() {
                lt(e).hide()
            }),
            h.done(function() {
                var t;
            ...
            for (r = 0; o > r; r++)
                i = g[r],
                u = h.createTween(i, m ? a[i] : 0),
                d[i] = a[i] || lt.style(e, i),
                i in a || (a[i] = u.start,
                m && (u.end = u.start,
    ...
    var W, U, X = typeof t, J = e.document, G = e.location, Q = e.jQuery, Y = e.$, K = {}, Z = [], et = "1.9.1", tt = Z.concat, nt = Z.push, it = Z.slice, rt = Z.indexOf, ot = K.toString, st = K.hasOwnProperty, at = et.trim, lt = function(e, t) {
        return new lt.fn.init(e,t,U)
    }, ut = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, ct = /\S+/g, pt = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, ht = /^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/, ft = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, dt = /^[\],:{}\s]*$/, gt = /(?:^|:|,)(?:\s*\[)+/g, mt = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g, vt = /"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g, yt = /^-ms-/, bt = /-([\da-z])/gi, xt = function(e, t) {
        return t.toUpperCase()
    }, wt = function(e) {
        (J.addEventListener || "load" === e.type || "complete" === J.readyState) && (kt(),
        lt.ready())
    }, kt = function() {
        J.addEventListener ? (J.removeEventListener("DOMContentLoaded", wt, !1),
        e.removeEventListener("load", wt, !1)) : (J.detachEvent("onreadystatechange", wt),
        ...
        --l); u > l; l++)
            if (null != (o = arguments[l]))
                for (r in o)
                    e = a[r],
                    i = o[r],
                    a !== i && (c && i && (lt.isPlainObject(i) || (n = lt.isArray(i))) ? (n ? (n = !1,
                    s = e && lt.isArray(e) ? e : []) : s = e && lt.isPlainObject(e) ? e : {},
                    a[r] = lt.extend(c, s, i)) : i !== t && (a[r] = i));
        return a
    }
    ,
    lt.extend({
        ...
        ready: function(e) {
            if (e === !0 ? !--lt.readyWait : !lt.isReady) {
                ...
                lt.isReady = !0,
                e !== !0 && --lt.readyWait > 0 || (W.resolveWith(J, [lt]),
        ...
        parseJSON: function(t) {
            ...
            t && dt.test(t.replace(mt, "@").replace(vt, "]").replace(gt, ""))) ? new Function("return " + t)() : (lt.error("Invalid JSON: " + t),
            void 0)
        },
        parseXML: function(n) {
            var i, r;
        ...
        proxy: function(e, n) {
            ...
            n = e,
            e = o),
            lt.isFunction(e) ? (i = it.call(arguments, 2),
            r = function() {
    ...
    lt.ready.promise = function(t) {
        if (!W)
            ...
            "complete" === J.readyState)
                ...
                J.addEventListener("DOMContentLoaded", wt, !1),
    ...
    lt.Callbacks = function(e) {
        ...
        var n, r, o, s, a, l, u = [], c = !e.once && [], p = function(t) {
            ...
            n = !1,
            u && (c ? c.length && p(c.shift()) : r ? u = [] : h.disable())
        }, h = {
            add: function() {
                if (u) {
                    var t = u.length;
    ...
    lt.extend({
        ...
        when: function(e) {
            var t, n, i, r = 0, o = it.call(arguments), s = o.length, a = 1 !== s || e && lt.isFunction(e.promise) ? s : 0, l = 1 === a ? e : lt.Deferred(), u = function(e, n, i) {
                return function(r) {
                    n[e] = this,
                    i[e] = arguments.length > 1 ? it.call(arguments) : r,
            ...
            if (s > 1)
                ...
                n = new Array(s),
                i = new Array(s); s > r; r++)
                    o[r] && lt.isFunction(o[r].promise) ? o[r].promise().done(u(r, i, o)).fail(l.reject).progress(u(r, n, t)) : --a;
            return a || l.resolveWith(i, o),
            l.promise()
        }
    }),
    lt.support = function() {
        var t, n, i, r, o, s, a, l, u, c, p = J.createElement("div");
        ...
        a = o.appendChild(J.createElement("option")),
        ...
        lt(function() {
            var n, i, r, o = "padding:0;margin:0;border:0;display:block;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;", s = J.getElementsByTagName("body")[0];
            s && (n = J.createElement("div"),
            n.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px",
            s.appendChild(n).appendChild(p),
            p.innerHTML = "<table><tr><td></td><td>t</td></tr></table>",
            r = p.getElementsByTagName("td"),
            ...
            i = p.appendChild(J.createElement("div")),
            i.style.cssText = p.style.cssText = o,
            i.style.marginRight = i.style.width = "0",
            p.style.width = "1px",
            t.reliableMarginRight = !parseFloat((e.getComputedStyle(i, null ) || {}).marginRight)),
            typeof p.style.zoom !== X && (p.innerHTML = "",
    ...
    lt.fn.extend({
        data: function(e, n) {
            var i, r, o = this[0], a = 0, l = null ;
            if (e === t) {
                if (this.length && (l = lt.data(o),
                1 === o.nodeType && !lt._data(o, "parsedAttrs"))) {
            ...
            return "object" == typeof e ? this.each(function() {
                ...
                return n === t ? o ? s(o, e, lt.data(o, e)) : null : (this.each(function() {
                    lt.data(this, e, n)
                }),
                void 0)
    ...
    lt.extend({
        queue: function(e, t, n) {
            ...
            i = lt._data(e, t),
            n && (!i || lt.isArray(n) ? i = lt._data(e, t, lt.makeArray(n)) : i.push(n)),
            i || []) : void 0
        },
    ...
    lt.fn.extend({
        queue: function(e, n) {
            ...
            e = "fx",
            i--),
            arguments.length < i ? lt.queue(this[0], e) : n === t ? this : this.each(function() {
        ...
        promise: function(e, n) {
            var i, r = 1, o = lt.Deferred(), s = this, a = this.length, l = function() {
                --r || o.resolveWith(s, [s])
            };
            for ("string" != typeof e && (n = e,
            e = t),
            e = e || "fx"; a--; )
                i = lt._data(s[a], e + "queueHooks"),
                i && i.empty && (r++,
                i.empty.add(l));
            return l(),
            o.promise(n)
    ...
    var Et, Nt, St = /[\t\r\n]/g, At = /\r/g, jt = /^(?:input|select|textarea|button|object)$/i, Lt = /^(?:a|area)$/i, $t = /^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i, Ht = /^(?:checked|selected)$/i, Dt = lt.support.getSetAttribute, Mt = lt.support.input;
    lt.fn.extend({
        attr: function(e, t) {
        ...
        addClass: function(e) {
            ...
            if (l)
                for (t = (e || "").match(ct) || []; a > s; s++)
                    if (n = this[s],
                    i = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(St, " ") : " ")) {
                        for (o = 0; r = t[o++]; )
                            i.indexOf(" " + r + " ") < 0 && (i += r + " ");
        ...
        toggleClass: function(e, t) {
            ...
            return lt.isFunction(e) ? this.each(function(n) {
                ...
                if ("string" === n)
                    for (var r, o = 0, s = lt(this), a = t, l = e.match(ct) || []; r = l[o++]; )
                        a = i ? a : !s.hasClass(r),
                        s[a ? "addClass" : "removeClass"](r);
                else
                    (n === X || "boolean" === n) && (this.className && lt._data(this, "__className__", this.className),
        ...
        val: function(e) {
            ...
            {
                if (arguments.length)
                    return r = lt.isFunction(e),
                    this.each(function(n) {
                        var o, s = lt(this);
                        1 === this.nodeType && (o = r ? e.call(this, n, s.val()) : e,
                ...
                if (o)
                    return i = lt.valHooks[o.type] || lt.valHooks[o.nodeName.toLowerCase()],
    ...
    lt.extend({
        ...
        attr: function(e, n, i) {
            ...
            if (e && 3 !== a && 8 !== a && 2 !== a)
                return typeof e.getAttribute === X ? lt.prop(e, n, i) : (o = 1 !== a || !lt.isXMLDoc(e),
                o && (n = n.toLowerCase(),
                r = lt.attrHooks[n] || ($t.test(n) ? Nt : Et)),
                i === t ? r && o && "get"in r && null !== (s = r.get(e, n)) ? s : (typeof e.getAttribute !== X && (s = e.getAttribute(n)),
                null == s ? t : s) : null !== i ? r && o && "set"in r && (s = r.set(e, i, n)) !== t ? s : (e.setAttribute(n, i + ""),
                i) : (lt.removeAttr(e, n),
                void 0))
        },
        removeAttr: function(e, t) {
            var n, i, r = 0, o = t && t.match(ct);
            if (o && 1 === e.nodeType)
                for (; n = o[r++]; )
                    i = lt.propFix[n] || n,
                    $t.test(n) ? !Dt && Ht.test(n) ? e[lt.camelCase("default-" + n)] = e[i] = !1 : e[i] = !1 : lt.attr(e, n, ""),
        ...
        propHooks: {
            tabIndex: {
                get: function(e) {
                    ...
                    return n && n.specified ? parseInt(n.value, 10) : jt.test(e.nodeName) || Lt.test(e.nodeName) && e.href ? 0 : t
                }
            }
        }
    }),
    Nt = {
        get: function(e, n) {
            var i = lt.prop(e, n)
              ...
              , o = "boolean" == typeof i ? Mt && Dt ? null != r : Ht.test(n) ? e[lt.camelCase("default-" + n)] : !!r : e.getAttributeNode(n);
            return o && o.value !== !1 ? n.toLowerCase() : t
        },
        set: function(e, t, n) {
            return t === !1 ? lt.removeAttr(e, n) : Mt && Dt || !Ht.test(n) ? e.setAttribute(!Dt && lt.propFix[n] || n, n) : e[lt.camelCase("default-" + n)] = e[n] = !0,
            n
        }
    },
    Mt && Dt || (lt.attrHooks.value = {
        ...
        set: function(e, t, n) {
            return lt.nodeName(e, "input") ? (e.defaultValue = t,
            void 0) : Et && Et.set(e, t, n)
        }
    }),
    Dt || (Et = lt.valHooks.button = {
        get: function(e, n) {
            var i = e.getAttributeNode(n);
    ...
    lt.event = {
        ...
        add: function(e, n, i, r, o) {
            var s, a, l, u, c, p, h, f, d, g, m, v = lt._data(e);
            if (v) {
                for (i.handler && (u = i,
                i = u.handler,
                o = u.selector),
                ...
                (p = v.handle) || (p = v.handle = function(e) {
                    return typeof lt === X || e && lt.event.triggered === e.type ? t : lt.event.dispatch.apply(p.elem, arguments)
                }
                ,
                p.elem = e),
                n = (n || "").match(ct) || [""],
                l = n.length; l--; )
                    ...
                    (f = a[d]) || (f = a[d] = [],
                    f.delegateCount = 0,
                    c.setup && c.setup.call(e, r, g, p) !== !1 || (e.addEventListener ? e.addEventListener(d, p, !1) : e.attachEvent && e.attachEvent("on" + d, p))),
        ...
        remove: function(e, t, n, i, r) {
            var o, s, a, l, u, c, p, h, f, d, g, m = lt.hasData(e) && lt._data(e);
            if (m && (c = m.events)) {
                for (t = (t || "").match(ct) || [""],
                u = t.length; u--; )
                    if (a = Ft.exec(t[u]) || [],
                    ...
                    d = (a[2] || "").split(".").sort(),
                    f) {
                        for (p = lt.event.special[f] || {},
                        f = (i ? p.delegateType : p.bindType) || f,
                        h = c[f] || [],
                        a = a[2] && new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                        l = o = h.length; o--; )
                            s = h[o],
                            !r && g !== s.origType || n && n.guid !== s.guid || a && !a.test(s.namespace) || i && i !== s.selector && ("**" !== i || !s.selector) || (h.splice(o, 1),
                            s.selector && h.delegateCount--,
                            p.remove && p.remove.call(e, s));
                        l && !h.length && (p.teardown && p.teardown.call(e, d, m.handle) !== !1 || lt.removeEvent(e, f, m.handle),
                        delete c[f])
                    } else
                        for (f in c)
                            lt.event.remove(e, f + t[u], n, i, !0);
                lt.isEmptyObject(c) && (delete m.handle,
                lt._removeData(e, "events"))
            }
        },
        trigger: function(n, i, r, o) {
            var s, a, l, u, c, p, h, f = [r || J], d = st.call(n, "type") ? n.type : n, g = st.call(n, "namespace") ? n.namespace.split(".") : [];
            if (l = p = r = r || J,
            3 !== r.nodeType && 8 !== r.nodeType && !Bt.test(d + lt.event.triggered) && (d.indexOf(".") >= 0 && (g = d.split("."),
            d = g.shift(),
            g.sort()),
            a = d.indexOf(":") < 0 && "on" + d,
            n = n[lt.expando] ? n : new lt.Event(d,"object" == typeof n && n),
            n.isTrigger = !0,
            n.namespace = g.join("."),
            ...
            c = lt.event.special[d] || {},
            o || !c.trigger || c.trigger.apply(r, i) !== !1)) {
                if (!o && !c.noBubble && !lt.isWindow(r)) {
                    for (u = c.delegateType || d,
                    Bt.test(u + d) || (l = l.parentNode); l; l = l.parentNode)
                        f.push(l),
                        p = l;
                    p === (r.ownerDocument || J) && f.push(p.defaultView || p.parentWindow || e)
                }
                for (h = 0; (l = f[h++]) && !n.isPropagationStopped(); )
                    n.type = h > 1 ? u : c.bindType || d,
                    s = (lt._data(l, "events") || {})[n.type] && lt._data(l, "handle"),
                    s && s.apply(l, i),
                    s = a && l[a],
                    s && lt.acceptData(l) && s.apply && s.apply(l, i) === !1 && n.preventDefault();
                if (n.type = d,
                !(o || n.isDefaultPrevented() || c._default && c._default.apply(r.ownerDocument, i) !== !1 || "click" === d && lt.nodeName(r, "a") || !lt.acceptData(r) || !a || !r[d] || lt.isWindow(r))) {
                    p = r[a],
                    p && (r[a] = null ),
        ...
        dispatch: function(e) {
            e = lt.event.fix(e);
            var n, i, r, o, s, a = [], l = it.call(arguments), u = (lt._data(this, "events") || {})[e.type] || [], c = lt.event.special[e.type] || {};
            if (l[0] = e,
            e.delegateTarget = this,
            !c.preDispatch || c.preDispatch.call(this, e) !== !1) {
                for (a = lt.event.handlers.call(this, e, u),
                n = 0; (o = a[n++]) && !e.isPropagationStopped(); )
                    ...
                    s = 0; (r = o.handlers[s++]) && !e.isImmediatePropagationStopped(); )
                        ...
                        e.data = r.data,
                        i = ((lt.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l),
        ...
        fix: function(e) {
            ...
            for (s || (this.fixHooks[r] = s = Rt.test(r) ? this.mouseHooks : qt.test(r) ? this.keyHooks : {}),
        ...
        special: {
            ...
            blur: {
                trigger: function() {
                    return this === J.activeElement && this.blur ? (this.blur(),
                    !1) : void 0
                },
    ...
    : function(e, t, n) {
        var i = "on" + t;
        e.detachEvent && (typeof e[i] === X && (e[i] = null ),
        e.detachEvent(i, n))
    }
    ,
    ...
    function(e, t) {
        ...
        function s(e, t, n, i) {
            var r, o, s, a, l, u, c, f, d, g;
            if ((t ? t.ownerDocument || t : F) !== L && j(t),
            t = t || L,
            n = n || [],
            !e || "string" != typeof e)
                return n;
            ...
            if (!H && !i) {
                if (r = gt.exec(e))
                    if (s = r[1]) {
                        ...
                        if (r[2])
                            return Y.apply(n, K.call(t.getElementsByTagName(e), 0)),
                            n;
                        if ((s = r[3]) && P.getByClassName && t.getElementsByClassName)
                            return Y.apply(n, K.call(t.getElementsByClassName(s), 0)),
                            n
                    }
                if (P.qsa && !D.test(e)) {
                    if (c = !0,
                    ...
                    1 === a && "object" !== t.nodeName.toLowerCase()) {
                        for (u = p(e),
                        (c = t.getAttribute("id")) ? f = c.replace(yt, "\\$&") : t.setAttribute("id", f),
                        f = "[id='" + f + "'] ",
                        l = u.length; l--; )
                            u[l] = f + h(u[l]);
                        d = ft.test(e) && t.parentNode || t,
                        g = u.join(",")
                    }
                    if (g)
                        try {
                            return Y.apply(n, K.call(d.querySelectorAll(g), 0)),
                            n
                        } catch (m) {} finally {
        ...
        function a(e, t) {
            var n = t && e
              , i = n && (~t.sourceIndex || J) - (~e.sourceIndex || J);
            if (i)
                return i;
            if (n)
                for (; n = n.nextSibling; )
        ...
        function p(e, t) {
            var n, i, r, o, a, l, u, c = W[e + " "];
            if (c)
                return t ? 0 : c.slice(0);
            for (a = e,
            l = [],
            u = _.preFilter; a; ) {
                (!n || (i = at.exec(a))) && (i && (a = a.slice(i[0].length) || a),
                l.push(r = [])),
                n = !1,
                (i = ut.exec(a)) && (n = i.shift(),
                r.push({
                    value: n,
                    type: i[0].replace(st, " ")
                }),
                a = a.slice(n.length));
                for (o in _.filter)
                    !(i = ht[o].exec(a)) || u[o] && !(i = u[o](i)) || (n = i.shift(),
                    r.push({
                        value: n,
                        type: o,
                        matches: i
            ...
            return t ? a.length : a ? s.error(e) : W(e, l).slice(0)
        }
        function h(e) {
        ...
        function m(e, t, n, i, o, s) {
            ...
            o && !o[B] && (o = m(o, s)),
            r(function(r, s, a, l) {
                var u, c, p, h = [], f = [], d = s.length, m = r || b(t || "*", a.nodeType ? [a] : a, []), v = !e || !r && t ? m : g(m, h, e, a, l), y = n ? o || (r ? e : d || i) ? [] : s : v;
                if (n && n(v, y, a, l),
                i)
                    for (u = g(y, f),
                    i(u, [], a, l),
                ...
                if (r) {
                    if (o || e) {
                        ...
                        for (c = y.length; c--; )
                            (p = y[c]) && (u = o ? Z.call(r, p) : h[c]) > -1 && (r[u] = !(s[u] = p))
                    }
                } else
                    y = g(y === s ? y.splice(d, y.length) : y),
                    o ? o(null , s, y, l) : Y.apply(s, y)
            })
        }
        function v(e) {
                ...
                if (n = _.relative[e[a].type])
                    ...
                    n[B]) {
                        for (i = ++a; r > i && !_.relative[e[i].type]; i++)
                            ;
                        return m(a > 1 && d(c), a > 1 && h(e.slice(0, a - 1)).replace(st, "$1"), n, i > a && v(e.slice(a, i)), r > i && v(e = e.slice(i)), r > i && h(e))
                    }
                    c.push(n)
                }
            return d(c)
        ...
        function y(e, t) {
            var n = 0
              ...
              , a = function(r, a, l, u, c) {
                var p, h, f, d = [], m = 0, v = "0", y = r && [], b = null != c, x = A, w = r || o && _.find.TAG("*", c && a.parentNode || a), k = I += null == x ? 1 : Math.random() || .1;
                for (b && (A = a !== L && a,
                T = n); null != (p = w[v]); v++) {
                    if (o && p) {
                        for (h = 0; f = e[h++]; )
                ...
                i && v !== m) {
                    ...
                    if (r) {
                        if (m > 0)
                            for (; v--; )
                                y[v] || d[v] || (d[v] = Q.call(u));
                        d = g(d)
                    }
                    Y.apply(u, d),
                    b && !r && d.length > 0 && m + t.length > 1 && s.uniqueSort(u)
                }
                return b && (I = k,
                A = x),
                y
        ...
        function x(e, t, n, i) {
            ...
            if (!i && 1 === u.length) {
                ...
                o.length > 2 && "ID" === (s = o[0]).type && 9 === t.nodeType && !H && _.relative[o[1].type]) {
                    if (t = _.find.ID(s.matches[0].replace(xt, wt), t)[0],
                    !t)
                        return n;
                ...
                !_.relative[a = s.type]); )
                    if ((l = _.find[a]) && (i = l(s.matches[0].replace(xt, wt), ft.test(o[0].type) && t.parentNode || t))) {
                        if (o.splice(r, 1),
                        e = i.length && h(o),
                        !e)
                            return Y.apply(n, K.call(i, 0)),
                            n;
                        break
                    }
            }
            return N(e, u)(i, t, H, n, ft.test(e)),
            n
        }
        function w() {}
        var k, T, _, C, E, N, S, A, j, L, $, H, D, M, O, q, R, B = "sizzle" + -new Date, F = e.document, P = {}, I = 0, V = 0, z = i(), W = i(), U = i(), X = typeof t, J = 1 << 31, G = [], Q = G.pop, Y = G.push, K = G.slice, Z = G.indexOf || function(e) {
            for (var t = 0, n = this.length; n > t; t++)
                if (this[t] === e)
                    return t;
            return -1
        }
        , et = "[\\x20\\t\\r\\n\\f]", tt = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", nt = tt.replace("w", "w#"), it = "([*^$|!~]?=)", rt = "\\[" + et + "*(" + tt + ")" + et + "*(?:" + it + et + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + nt + ")|)|)" + et + "*\\]", ot = ":(" + tt + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + rt.replace(3, 8) + ")*)|.*)\\)|)", st = new RegExp("^" + et + "+|((?:^|[^\\\\])(?:\\\\.)*)" + et + "+$","g"), at = new RegExp("^" + et + "*," + et + "*"), ut = new RegExp("^" + et + "*([\\x20\\t\\r\\n\\f>+~])" + et + "*"), ct = new RegExp(ot), pt = new RegExp("^" + nt + "$"), ht = {
            ID: new RegExp("^#(" + tt + ")"),
            CLASS: new RegExp("^\\.(" + tt + ")"),
        ...
        j = s.setDocument = function(e) {
            ...
            $ = i.documentElement,
            H = E(i),
            P.tagNameNoComments = o(function(e) {
            ...
            P.getByName = o(function(e) {
                ...
                var t = i.getElementsByName && i.getElementsByName(B).length === 2 + i.getElementsByName(B + 0).length;
                return P.getIdNotName = !i.getElementById(B),
                $.removeChild(e),
                t
            }),
            ...
            _.filter.ID = function(e) {
                ...
                if (typeof n.getElementById !== X && !H) {
            ...
            _.find.CLASS = P.getByClassName && function(e, t) {
                return typeof t.getElementsByClassName === X || H ? void 0 : t.getElementsByClassName(e)
            }
            ,
            M = [],
            D = [":focus"],
            (P.qsa = n(i.querySelectorAll)) && (o(function(e) {
                e.innerHTML = "<select><option selected=''></option></select>",
                e.querySelectorAll("[selected]").length || D.push("\\[" + et + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)"),
                e.querySelectorAll(":checked").length || D.push(":checked")
            }),
            o(function(e) {
                e.innerHTML = "<input type='hidden' i=''/>",
                e.querySelectorAll("[i^='']").length && D.push("[*^$]=" + et + "*(?:\"\"|'')"),
                e.querySelectorAll(":enabled").length || D.push(":enabled", ":disabled"),
                e.querySelectorAll("*,:x"),
                D.push(",.*:")
            })),
            (P.matchesSelector = n(O = $.matchesSelector || $.mozMatchesSelector || $.webkitMatchesSelector || $.oMatchesSelector || $.msMatchesSelector)) && o(function(e) {
                P.disconnectedMatch = O.call(e, "div"),
                O.call(e, "[s!='']:x"),
                M.push("!=", ot)
            }),
            D = new RegExp(D.join("|")),
            M = new RegExp(M.join("|")),
            q = n($.contains) || $.compareDocumentPosition ? function(e, t) {
            ...
            ,
            R = $.compareDocumentPosition ? function(e, t) {
                var n;
                return e === t ? (S = !0,
        ...
        s.matchesSelector = function(e, t) {
            ...
            t = t.replace(bt, "='$1']"),
            !(!P.matchesSelector || H || M && M.test(t) || D.test(t)))
                try {
                    var n = O.call(e, t);
        ...
        s.attr = function(e, t) {
            ...
            return (e.ownerDocument || e) !== L && j(e),
            H || (t = t.toLowerCase()),
            (n = _.attrHandle[t]) ? n(e) : H || P.attributes ? e.getAttribute(t) : ((n = e.getAttributeNode(t)) || e.getAttribute(t)) && e[t] === !0 ? t : n && n.specified ? n.value : null
        }
        ,
        s.error = function(e) {
        ...
        _ = s.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[5] && e[2];
                    return ht.CHILD.test(e[0]) ? null : (e[4] ? e[2] = e[4] : n && ct.test(n) && (t = p(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                ATTR: function(e, t, n) {
                    return function(i) {
                        var r = s.attr(i, e);
                        return null == r ? "!=" === t : t ? (r += "",
                        "=" === t ? r === n : "!=" === t ? r !== n : "^=" === t ? n && 0 === r.indexOf(n) : "*=" === t ? n && r.indexOf(n) > -1 : "$=" === t ? n && r.slice(-n.length) === n : "~=" === t ? (" " + r + " ").indexOf(n) > -1 : "|=" === t ? r === n || r.slice(0, n.length + 1) === n + "-" : !1) : !0
                    }
                },
                CHILD: function(e, t, n, i, r) {
                    ...
                    : function(t, n, l) {
                        var u, c, p, h, f, d, g = o !== s ? "nextSibling" : "previousSibling", m = t.parentNode, v = a && t.nodeName.toLowerCase(), y = !l && !a;
                        if (m) {
                            if (o) {
                                for (; g; ) {
                                    for (p = t; p = p[g]; )
                            ...
                            } else if (y && (u = (t[B] || (t[B] = {}))[e]) && u[0] === I)
                                h = u[1];
                            else
                                for (; (p = ++f && p && p[g] || (h = f = 0) || d.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++h || (y && ((p[B] || (p[B] = {}))[e] = [I, h]),
                                p !== t)); )
                                    ;
                            return h -= r,
                            h === i || 0 === h % i && h / i >= 0
                ...
                PSEUDO: function(e, t) {
                    ...
                    _.setFilters.hasOwnProperty(e.toLowerCase()) ? r(function(e, n) {
            ...
            pseudos: {
                ...
                lang: r(function(e) {
                    return pt.test(e || "") || s.error("unsupported lang: " + e),
                    e = e.replace(xt, wt).toLowerCase(),
                    function(t) {
                        var n;
                        do
        ...
        lt.unique = s.uniqueSort,
        lt.text = s.getText,
        lt.isXMLDoc = s.isXML,
        lt.contains = s.contains
    }(e);
    var Pt = /Until$/
    ...
    lt.each({
        ...
        lt.fn[e] = function(n, i) {
            ...
            return Pt.test(e) || (i = n),
            i && "string" == typeof i && (r = lt.filter(i, r)),
            r = this.length > 1 && !Wt[e] ? lt.unique(r) : r,
    ...
    lt.fn.extend({
        ...
        remove: function(e, t) {
            for (var n, i = 0; null != (n = this[i]); i++)
                (!e || lt.filter(e, [n]).length > 0) && (t || 1 !== n.nodeType || lt.cleanData(b(n)),
                n.parentNode && (t && lt.contains(n.ownerDocument, n) && m(b(n, "script")),
                n.parentNode.removeChild(n)));
            return this
        },
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++) {
                for (1 === e.nodeType && lt.cleanData(b(e, !1)); e.firstChild; )
        ...
        html: function(e) {
            return lt.access(this, function(e) {
                ...
                if (!("string" != typeof e || en.test(e) || !lt.support.htmlSerialize && Jt.test(e) || !lt.support.leadingWhitespace && Gt.test(e) || an[(Yt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(Qt, "<$1></$2>");
                    try {
                        for (; r > i; i++)
                            n = this[i] || {},
        ...
        domManip: function(e, n, i) {
            e = tt.apply([], e);
            var r, o, s, a, l, u, c = 0, p = this.length, h = this, m = p - 1, v = e[0], y = lt.isFunction(v);
            if (y || !(1 >= p || "string" != typeof v || lt.support.checkClone) && nn.test(v))
                return this.each(function(r) {
                    var o = h.eq(r);
                    y && (e[0] = v.call(this, r, n ? o.html() : t)),
                    o.domManip(e, n, i)
                });
            if (p && (u = lt.buildFragment(e, this[0].ownerDocument, !1, this),
            r = u.firstChild,
            1 === u.childNodes.length && (u = r),
            r)) {
                for (n = n && lt.nodeName(r, "tr"),
                a = lt.map(b(u, "script"), d),
                s = a.length; p > c; c++)
                    o = u,
                    c !== m && (o = lt.clone(o, !0, !0),
                    s && lt.merge(a, b(o, "script"))),
                    i.call(n && lt.nodeName(this[c], "table") ? f(this[c], "tbody") : this[c], o, c);
                if (s)
                    for (l = a[a.length - 1].ownerDocument,
                    lt.map(a, g),
                    c = 0; s > c; c++)
                        o = a[c],
                        rn.test(o.type || "") && !lt._data(o, "globalEval") && lt.contains(l, o) && (o.src ? lt.ajax({
                            url: o.src,
                            type: "GET",
                            dataType: "script",
                            async: !1,
                            global: !1,
                            "throws": !0
                        }) : lt.globalEval((o.text || o.textContent || o.innerHTML || "").replace(sn, "")));
                u = r = null
            }
            return this
        }
    ...
    lt.each({
        ...
        lt.fn[e] = function(e) {
            for (var n, i = 0, r = [], o = lt(e), s = o.length - 1; s >= i; i++)
    ...
    lt.extend({
        clone: function(e, t, n) {
            ...
            if (lt.support.html5Clone || lt.isXMLDoc(e) || !Jt.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (un.innerHTML = e.outerHTML,
        ...
        buildFragment: function(e, t, n, i) {
            for (var r, o, s, a, l, u, c, p = e.length, f = h(t), d = [], g = 0; p > g; g++)
                if (o = e[g],
                o || 0 === o)
                    if ("object" === lt.type(o))
                        lt.merge(d, o.nodeType ? [o] : o);
                    else if (Zt.test(o)) {
                        for (a = a || f.appendChild(t.createElement("div")),
                        l = (Yt.exec(o) || ["", ""])[1].toLowerCase(),
                        c = an[l] || an._default,
                        a.innerHTML = c[1] + o.replace(Qt, "<$1></$2>") + c[2],
                        r = c[0]; r--; )
                            a = a.lastChild;
                        if (!lt.support.leadingWhitespace && Gt.test(o) && d.push(t.createTextNode(Gt.exec(o)[0])),
                        !lt.support.tbody)
                            for (o = "table" !== l || Kt.test(o) ? "<table>" !== c[1] || Kt.test(o) ? 0 : a : a.firstChild,
                            r = o && o.childNodes.length; r--; )
                                lt.nodeName(u = o.childNodes[r], "tbody") && !u.childNodes.length && o.removeChild(u);
                        for (lt.merge(d, a.childNodes),
            ...
            lt.support.appendChecked || lt.grep(b(d, "input"), x),
            g = 0; o = d[g++]; )
                if ((!i || -1 === lt.inArray(o, i)) && (s = lt.contains(o.ownerDocument, o),
        ...
        cleanData: function(e, t) {
            for (var n, i, r, o, s = 0, a = lt.expando, l = lt.cache, u = lt.support.deleteExpando, c = lt.event.special; null != (n = e[s]); s++)
                if ((t || lt.acceptData(n)) && (r = n[a],
                o = r && l[r])) {
                    if (o.events)
                        for (i in o.events)
                            c[i] ? lt.event.remove(n, i) : lt.removeEvent(n, i, o.handle);
                    l[r] && (delete l[r],
                    u ? delete n[a] : typeof n.removeAttribute !== X ? n.removeAttribute(a) : n[a] = null ,
                    Z.push(r))
                }
        }
    });
    var cn, pn, hn, fn = /alpha\([^)]*\)/i, dn = /opacity\s*=\s*([^)]*)/, gn = /^(top|right|bottom|left)$/, mn = /^(none|table(?!-c[ea]).+)/, vn = /^margin/, yn = new RegExp("^(" + ut + ")(.*)$","i"), bn = new RegExp("^(" + ut + ")(?!px)[a-z%]+$","i"), xn = new RegExp("^([+-])=(" + ut + ")","i"), wn = {
        BODY: "block"
    }, kn = {
        position: "absolute",
        visibility: "hidden",
    ...
    lt.extend({
        ...
        style: function(e, n, i, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, s, a, l = lt.camelCase(n), u = e.style;
                if (n = lt.cssProps[l] || (lt.cssProps[l] = w(u, l)),
                a = lt.cssHooks[n] || lt.cssHooks[l],
                i === t)
                    return a && "get"in a && (o = a.get(e, !1, r)) !== t ? o : u[n];
                if (s = typeof i,
                "string" === s && (o = xn.exec(i)) && (i = (o[1] + 1) * o[2] + parseFloat(lt.css(e, n)),
                s = "number"),
                !(null == i || "number" === s && isNaN(i) || ("number" !== s || lt.cssNumber[l] || (i += "px"),
    ...
    ) : J.documentElement.currentStyle && (pn = function(e) {
    ...
    lt.each(["height", "width"], function(e, t) {
        lt.cssHooks[t] = {
            ...
            set: function(e, n, i) {
                var r = i && pn(e);
                return _(e, n, i ? C(e, t, i, lt.support.boxSizing && "border-box" === lt.css(e, "boxSizing", !1, r), r) : 0)
            }
        }
    }),
    ...
    lt(function() {
        ...
        !lt.support.pixelPosition && lt.fn.position && lt.each(["top", "left"], function(e, t) {
            lt.cssHooks[t] = {
                get: function(e, n) {
                    return n ? (n = hn(e, t),
                    bn.test(n) ? lt(e).position()[t] + "px" : n) : void 0
                }
            }
        })
    }),
        ...
        lt.cssHooks[e + t] = {
            expand: function(n) {
                for (var i = 0, r = {}, o = "string" == typeof n ? n.split(" ") : [n]; 4 > i; i++)
                    r[e + _n[i] + t] = o[i] || o[i - 2] || o[0];
                return r
            }
        },
        vn.test(e) || (lt.cssHooks[e + t].set = _)
    });
    var En = /%20/g
      , Nn = /\[\]$/
      , Sn = /\r?\n/g
    ...
    ;
    var Ln, $n, Hn = lt.now(), Dn = /\?/, Mn = /#.*$/, On = /([?&])_=[^&]*/, qn = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Rn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Bn = /^(?:GET|HEAD)$/, Fn = /^\/\//, Pn = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, In = lt.fn.load, Vn = {}, zn = {}, Wn = "*/".concat("*");
    try {
        $n = G.href
    } catch (Un) {
        $n = J.createElement("a"),
    ...
    lt.fn.load = function(e, n, i) {
        ...
        a.length > 0 && lt.ajax({
            ...
            o = arguments,
            a.html(r ? lt("<div>").append(lt.parseHTML(e)).find(r) : e)
    ...
    lt.extend({
        ...
        ajax: function(e, n) {
            function i(e, n, i, r) {
                ...
                i && (b = H(h, k, i)),
                e >= 200 && 300 > e || 304 === e ? (h.ifModified && (w = k.getResponseHeader("Last-Modified"),
                w && (lt.lastModified[s] = w),
                w = k.getResponseHeader("etag"),
                w && (lt.etag[s] = w)),
                204 === e ? (o = !0,
                T = "nocontent") : 304 === e ? (o = !0,
                T = "notmodified") : (o = D(h, b),
                T = o.state,
                p = o.data,
                y = o.error,
                o = !y)) : (y = T,
                ...
                k.status = e,
                k.statusText = (n || T) + "",
                o ? g.resolveWith(f, [p, T, k]) : g.rejectWith(f, [k, T, y]),
                k.statusCode(v),
                v = t,
                u && d.trigger(o ? "ajaxSuccess" : "ajaxError", [k, h, o ? p : y]),
                m.fireWith(f, [k, T]),
                u && (d.trigger("ajaxComplete", [k, h]),
                --lt.active || lt.event.trigger("ajaxStop")))
            }
            "object" == typeof e && (n = e,
            e = t),
            n = n || {};
            var r, o, s, a, l, u, c, p, h = lt.ajaxSetup({}, n), f = h.context || h, d = h.context && (f.nodeType || f.jquery) ? lt(f) : lt.event, g = lt.Deferred(), m = lt.Callbacks("once memory"), v = h.statusCode || {}, y = {}, b = {}, x = 0, w = "canceled", k = {
                readyState: 0,
            ...
            k.success = k.done,
            k.error = k.fail,
            h.url = ((e || h.url || $n) + "").replace(Mn, "").replace(Fn, Ln[1] + "//"),
            h.type = n.method || n.type || h.method || h.type,
            h.dataTypes = lt.trim(h.dataType || "*").toLowerCase().match(ct) || [""],
            null == h.crossDomain && (r = Pn.exec(h.url.toLowerCase()),
            h.crossDomain = !(!r || r[1] === Ln[1] && r[2] === Ln[2] && (r[3] || ("http:" === r[1] ? 80 : 443)) == (Ln[3] || ("http:" === Ln[1] ? 80 : 443)))),
            ...
            s = h.url,
            h.hasContent || (h.data && (s = h.url += (Dn.test(s) ? "&" : "?") + h.data,
            delete h.data),
            h.cache === !1 && (h.url = On.test(s) ? s.replace(On, "$1_=" + Hn++) : s + (Dn.test(s) ? "&" : "?") + "_=" + Hn++)),
            h.ifModified && (lt.lastModified[s] && k.setRequestHeader("If-Modified-Since", lt.lastModified[s]),
            lt.etag[s] && k.setRequestHeader("If-None-Match", lt.etag[s])),
            (h.data && h.hasContent && h.contentType !== !1 || n.contentType) && k.setRequestHeader("Content-Type", h.contentType),
            k.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Wn + "; q=0.01" : "") : h.accepts["*"]);
            for (o in h.headers)
                k.setRequestHeader(o, h.headers[o]);
            if (h.beforeSend && (h.beforeSend.call(f, k, h) === !1 || 2 === x))
                return k.abort();
            w = "abort";
            for (o in {
                success: 1,
    ...
    lt.ajaxSetup({
        ...
        jsonpCallback: function() {
            var e = Xn.pop() || lt.expando + "_" + Hn++;
            return this[e] = !0,
            e
        }
    }),
    lt.ajaxPrefilter("json jsonp", function(n, i, r) {
        var o, s, a, l = n.jsonp !== !1 && (Jn.test(n.url) ? "url" : "string" == typeof n.data && !(n.contentType || "").indexOf("application/x-www-form-urlencoded") && Jn.test(n.data) && "data");
        return l || "jsonp" === n.dataTypes[0] ? (o = n.jsonpCallback = lt.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback,
        l ? n[l] = n[l].replace(Jn, "$1" + o) : n.jsonp !== !1 && (n.url += (Dn.test(n.url) ? "&" : "?") + n.jsonp + "=" + o),
        n.converters["script json"] = function() {
            return a || lt.error(o + " was not called"),
            a[0]
        }
        ,
        n.dataTypes[0] = "json",
        ...
        if (!n.crossDomain || lt.support.cors) {
            ...
            return {
                send: function(r, o) {
                    ...
                    i = function(e, r) {
                        ...
                        try {
                            if (i && (r || 4 === l.readyState))
                                if (i = t,
                                s && (l.onreadystatechange = lt.noop,
                                Kn && delete Gn[s]),
                                r)
                    ...
                    ,
                    n.async ? 4 === l.readyState ? setTimeout(i) : (s = ++Yn,
                    Kn && (Gn || (Gn = {},
                    lt(e).unload(Kn)),
                    Gn[s] = i),
    ...
    var Zn, ei, ti = /^(?:toggle|show|hide)$/, ni = new RegExp("^(?:([+-])=|)(" + ut + ")([a-z%]*)$","i"), ii = /queueHooks$/, ri = [P], oi = {
        "*": [function(e, t) {
            var n, i, r = this.createTween(e, t), o = ni.exec(t), s = r.cur(), a = +s || 0, l = 1, u = 20;
            if (o) {
                if (n = +o[2],
                i = o[3] || (lt.cssNumber[e] ? "" : "px"),
                "px" !== i && a) {
                    a = lt.css(r.elem, e, !0) || n || 1;
                    do
                        l = l || ".5",
                        a /= l,
                        lt.style(r.elem, e, a + i);
    ...
    lt.fn.extend({
        ...
        finish: function(e) {
            return e !== !1 && (e = e || "fx"),
            this.each(function() {
                var t, n = lt._data(this), i = n[e + "queue"], r = n[e + "queueHooks"], o = lt.timers, s = i ? i.length : 0;
                for (n.finish = !0,
                lt.queue(this, e, []),
    ...
    lt.fn.offset = function(e) {
        ...
        if (s)
            ...
            lt.contains(n, o) ? (typeof o.getBoundingClientRect !== X && (r = o.getBoundingClientRect()),
            i = z(s),
            {
    ...
    lt.offset = {
        setOffset: function(e, t, n) {
            ...
            var r, o, s = lt(e), a = s.offset(), l = lt.css(e, "top"), u = lt.css(e, "left"), c = ("absolute" === i || "fixed" === i) && lt.inArray("auto", [l, u]) > -1, p = {}, h = {};
            c ? (h = s.position(),
            r = h.top,
            o = h.left) : (r = parseFloat(l) || 0,
            o = parseFloat(u) || 0),
            lt.isFunction(t) && (t = t.call(e, n, a)),
    ...
    lt.each({
        ...
        lt.fn[e] = function(r) {
            return lt.access(this, function(e, r, o) {
                var s = z(e);
                return o === t ? s ? n in s ? s[n] : s.document.documentElement[r] : e[r] : (s ? s.scrollTo(i ? lt(s).scrollLeft() : o, i ? o : lt(s).scrollTop()) : e[r] = o,
                void 0)
        ...
        lt.each({
            ...
            lt.fn[r] = function(r, o) {
                ...
                return lt.access(this, function(n, i, r) {
                    ...
                    Math.max(n.body["scroll" + e], o["scroll" + e], n.body["offset" + e], o["offset" + e], o["client" + e])) : r === t ? lt.css(n, i, a) : lt.style(n, i, r, a)
                }, n, s ? r : t, s, null )
            }
        })
    }),
...
function() {
    var e = this
      ...
      , k = o.bind
      , T = function(e) {
        return e instanceof T ? e : this instanceof T ? (this._wrapped = e,
        void 0) : new T(e)
    };
    "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = T),
    exports._ = T) : e._ = T,
    T.VERSION = "1.4.4";
    var _ = T.each = T.forEach = function(e, t, i) {
        if (null != e)
            if (p && e.forEach === p)
                e.forEach(t, i);
                ...
                for (var s in e)
                    if (T.has(e, s) && t.call(i, e[s], s, e) === n)
                        return
    }
    ;
    ...
    T.filter = T.select = function(e, t, n) {
        var i = [];
        return null == e ? i : g && e.filter === g ? e.filter(t, n) : (_(e, function(e, r, o) {
    ...
    T.every = T.all = function(e, t, i) {
        t || (t = T.identity);
        var r = !0;
        return null == e ? r : m && e.every === m ? e.every(t, i) : (_(e, function(e, o, s) {
    ...
    var E = T.some = T.any = function(e, t, i) {
        t || (t = T.identity);
        var r = !1;
        return null == e ? r : v && e.some === v ? e.some(t, i) : (_(e, function(e, o, s) {
    ...
    var A = function(e, t, n) {
        return _(e, function(e) {
            T.isArray(e) ? t ? s.apply(n, e) : A(e, t, n) : n.push(e)
        }),
        n
    };
    ...
    T.uniq = T.unique = function(e, t, n, i) {
        ...
        return _(r, function(n, i) {
            (t ? i && s[s.length - 1] === n : T.contains(s, n)) || (s.push(n),
            o.push(e[i]))
        }),
        o
    }
    ...
    ,
    T.zip = function() {
        for (var e = a.call(arguments), t = T.max(T.pluck(e, "length")), n = new Array(t), i = 0; t > i; i++)
            n[i] = T.pluck(e, "" + i);
        return n
    }
    ,
    ...
    T.bind = function(e, t) {
        if (e.bind === k && k)
            return k.apply(e, a.call(arguments, 1));
        var n = a.call(arguments, 2);
        return function() {
    ...
    T.throttle = function(e, t) {
        ...
        return function() {
            ...
            r = null ,
            s = l,
            o = e.apply(n, i)) : r || (r = setTimeout(a, u)),
            o
        }
    }
    ,
    ...
    var j = function(e, t, n, i) {
        ...
        if ("[object Array]" == r) {
            if (s = e.length,
            a = s == t.length)
                for (; s-- && (a = j(e[s], t[s], n, i)); )
                    ;
        } else {
            var l = e.constructor
              , c = t.constructor;
            if (l !== c && !(T.isFunction(l) && l instanceof l && T.isFunction(c) && c instanceof c))
                return !1;
            for (var p in e)
                if (T.has(e, p) && (s++,
                !(a = T.has(t, p) && j(e[p], t[p], n, i))))
                    break;
            if (a) {
                for (p in t)
                    if (T.has(t, p) && !s--)
    ...
    ,
    T.mixin = function(e) {
        _(T.functions(e), function(t) {
            var n = T[t] = e[t];
            T.prototype[t] = function() {
                var e = [this._wrapped];
                return s.apply(e, arguments),
                q.call(this, n.apply(T, e))
            }
        })
    }
    ;
    ...
    T.template = function(e, t, n) {
        ...
        e.replace(r, function(t, n, i, r, a) {
            return s += e.slice(o, a).replace(O, function(e) {
                return "\\" + M[e]
            }),
    ...
    T.mixin(T),
    _(["pop", "push", "reverse", "shift", "sort", "splice", "unshift"], function(e) {
        var t = i[e];
...
.call(this),
function() {
    var e, t = this, n = t.Backbone, i = [], r = i.push, o = i.slice, s = i.splice;
    ...
    a.each(h, function(e, t) {
        l[t] = function(t, n, i) {
            var r = this._listeners || (this._listeners = {})
              , o = t._listenerId || (t._listenerId = a.uniqueId("l"));
            return r[o] = t,
    ...
    var f = e.Model = function(e, t) {
        ...
        this.attributes = {},
        a.extend(this, a.pick(t, d)),
        t.parse && (i = this.parse(i, t) || {}),
        (n = a.result(this, "defaults")) && (i = a.defaults({}, i, n)),
        this.set(i, t),
        this.changed = {},
    ...
    a.extend(f.prototype, l, {
        ...
        set: function(e, t, n) {
            ...
            u = this._changing,
            this._changing = !0,
            u || (this._previousAttributes = a.clone(this.attributes),
            this.changed = {}),
            p = this.attributes,
        ...
        save: function(e, t, n) {
            ...
            !this._validate(i, n))
                return !1;
            i && n.wait && (this.attributes = a.extend({}, s, i)),
            ...
            return n.success = function(e) {
                l.attributes = s;
                var t = l.parse(e, n);
                return n.wait && (t = a.extend(i || {}, t)),
                a.isObject(t) && !l.set(t, n) ? !1 : (u && u(l, e, n),
            ...
            "patch" === r && (n.attrs = i),
            o = this.sync(r, this, n),
            i && n.wait && (this.attributes = s),
            o
        },
        destroy: function(e) {
            e = e ? a.clone(e) : {};
        ...
        url: function() {
            var e = a.result(this, "urlRoot") || a.result(this.collection, "url") || O();
    ...
    a.extend(m.prototype, l, {
        ...
        set: function(e, t) {
            ...
            a.isArray(e) || (e = e ? [e] : []);
            var n, i, o, l, u, c = t.at, p = this.comparator && null == c && t.sort !== !1, h = a.isString(this.comparator) ? this.comparator : null , f = [], d = [], g = {};
            for (n = 0,
            i = e.length; i > n; n++)
                (o = this._prepareModel(e[n], t)) && ((l = this.get(o)) ? (t.remove && (g[l.cid] = !0),
                t.merge && (l.set(o.attributes, t),
                p && !u && l.hasChanged(h) && (u = !0))) : t.add && (f.push(o),
            ...
            if (t.remove) {
                for (n = 0,
                i = this.length; i > n; ++n)
                    g[(o = this.models[n]).cid] || d.push(o);
                d.length && this.remove(d, t)
            }
            if (f.length && (p && (u = !0),
            this.length += f.length,
            null != c ? s.apply(this.models, [c, 0].concat(f)) : r.apply(this.models, f)),
            u && this.sort({
                silent: !0
            }),
            t.silent)
    ...
    a.extend(w.prototype, l, {
        ...
        delegateEvents: function(e) {
            ...
            for (var t in e) {
                ...
                n) {
                    ...
                    "" === o ? this.$el.on(r, n) : this.$el.on(r, o, n)
                }
            }
            return this
        },
        ...
        _configure: function(e) {
            this.options && (e = a.extend({}, a.result(this, "options"), e)),
            a.extend(this, a.pick(e, T)),
            this.options = e
        },
    ...
    e.sync = function(t, n, i) {
        ...
        if (i.url || (o.url = a.result(n, "url") || O()),
        null != i.data || !n || "create" !== t && "update" !== t && "patch" !== t || (o.contentType = "application/json",
        o.data = JSON.stringify(i.attrs || n.toJSON(i))),
        ...
        i.emulateHTTP && ("PUT" === r || "DELETE" === r || "PATCH" === r)) {
            o.type = "POST",
            i.emulateJSON && (o.data._method = r);
            var s = i.beforeSend;
        ...
        var l = i.xhr = e.ajax(a.extend(o, i));
    ...
    a.extend(C.prototype, l, {
        ...
        route: function(t, n, i) {
            a.isRegExp(t) || (t = this._routeToRegExp(t)),
            a.isFunction(n) && (i = n,
            n = ""),
            i || (i = this[n]);
            var r = this;
        ...
        _routeToRegExp: function(e) {
            return e = e.replace(A, "\\$&").replace(E, "(?:$1)?").replace(N, function(e, t) {
                return t ? e : "([^/]+)"
            }).replace(S, "(.*?)"),
            new RegExp("^" + e + "$")
        },
    ...
    a.extend(j.prototype, l, {
        ...
        start: function(t) {
            ...
            var n = this.getFragment()
              ...
              , r = H.exec(navigator.userAgent.toLowerCase()) && (!i || 7 >= i);
            ...
            this.fragment = n;
            var o = this.location
              , s = o.pathname.replace(/[^\/]$/, "$&/") === this.root;
            ...
            !0) : (this._wantsPushState && this._hasPushState && s && o.hash && (this.fragment = this.getHash().replace(L, ""),
    ...
    f.extend = m.extend = C.extend = w.extend = j.extend = M;
    var O = function() {
...
function() {
    ...
    function a(t, r) {
        try {
            return r && (r = s({}, a.defaults, r)),
            n.parse(e.lex(t, r), r)
        } catch (o) {
            if (o.message += "\nPlease report this to https://github.com/chjj/marked.",
            (r || a.defaults).silent)
                return "<p>An error occured:</p><pre>" + i(o.message + "", !0) + "</pre>";
            throw o
        }
    }
    var l = {
    ...
    l.bullet = /(?:[*+-]|\d+\.)/,
    l.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/,
    l.item = r(l.item, "gm")(/bull/g, l.bullet)(),
    l.list = r(l.list)(/bull/g, l.bullet)("hr", /\n+(?=(?: *[-*_]){3,} *(?:\n+|$))/)(),
    ...
    l.html = r(l.html)("comment", /<!--[\s\S]*?-->/)("closed", /<(tag)[\s\S]+?<\/\1>/)("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, l._tag)(),
    l.paragraph = r(l.paragraph)("hr", l.hr)("heading", l.heading)("lheading", l.lheading)("blockquote", l.blockquote)("tag", "<" + l._tag)("def", l.def)(),
    l.normal = s({}, l),
    l.gfm = s({}, l.normal, {
        fences: /^ *(`{3,}|~{3,}) *(\w+)? *\n([\s\S]+?)\s*\1 *(?:\n+|$)/,
        paragraph: /^/
    }),
    l.gfm.paragraph = r(l.paragraph)("(?!", "(?!" + l.gfm.fences.source.replace("\\1", "\\2") + "|")(),
    l.tables = s({}, l.gfm, {
        nptable: /^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/,
        table: /^ *\|(.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/
    }),
    ...
    e.prototype.token = function(e, t) {
        for (var n, i, r, o, s, a, u, c, p, e = e.replace(/^ +$/gm, ""); e; )
            if ((r = this.rules.newline.exec(e)) && (e = e.substring(r[0].length),
            r[0].length > 1 && this.tokens.push({
                type: "space"
            })),
            r = this.rules.code.exec(e))
                ...
                c = 0; c < a.align.length; c++)
                    a.align[c] = /^ *-+: *$/.test(a.align[c]) ? "right" : /^ *:-+: *$/.test(a.align[c]) ? "center" : /^ *:-+ *$/.test(a.align[c]) ? "left" : null ;
                ...
                this.options.smartLists && (o = l.bullet.exec(r[0])[0]),
                n = !1,
                p = r.length,
                c = 0; p > c; c++)
                    a = r[c],
                    ...
                    a = a.replace(/^ *([*+-]|\d+\.) +/, ""),
                    ~a.indexOf("\n ") && (u -= a.length,
                    a = this.options.pedantic ? a.replace(/^ {1,4}/gm, "") : a.replace(new RegExp("^ {1," + u + "}","gm"), "")),
                    this.options.smartLists && c !== p - 1 && (s = l.bullet.exec(r[c + 1])[0],
                    o === s || "." === o[1] && "." === s[1] || (e = r.slice(c + 1).join("\n") + e,
                    c = p - 1)),
                    i = n || /\n\n(?!\s*$)/.test(a),
                    c !== p - 1 && (n = "\n" === a[a.length - 1],
                    i || (i = n)),
    ...
    u._inside = /(?:\[[^\]]*\]|[^\]]|\](?=[^\[]*\]))*/,
    u._href = /\s*<?([^\s]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/,
    u.link = r(u.link)("inside", u._inside)("href", u._href)(),
    u.reflink = r(u.reflink)("inside", u._inside)(),
    u.normal = s({}, u),
    u.pedantic = s({}, u.normal, {
    ...
    t.prototype.output = function(e) {
        for (var t, n, r, o, s = ""; e; )
            if (o = this.rules.escape.exec(e))
                ...
                e = e.substring(o[0].length),
                "@" === o[2] ? (n = ":" === o[1][6] ? this.mangle(o[1].substring(7)) : this.mangle(o[1]),
                r = this.mangle("mailto:") + n) : (n = i(o[1]),
                r = n),
                s += '<a href="' + r + '">' + n + "</a>";
            else if (o = this.rules.url.exec(e))
                e = e.substring(o[0].length),
                n = i(o[1]),
                r = n,
                s += '<a href="' + r + '">' + n + "</a>";
                ...
                e = e.substring(o[0].length),
                s += this.options.sanitize ? i(o[0]) : o[0];
                ...
                e = e.substring(o[0].length),
                s += "<strong>" + this.output(o[2] || o[1]) + "</strong>";
            else if (o = this.rules.em.exec(e))
                e = e.substring(o[0].length),
                s += "<em>" + this.output(o[2] || o[1]) + "</em>";
    ...
    t.prototype.outputLink = function(e, t) {
        return "!" !== e[0][0] ? '<a href="' + i(t.href) + '"' + (t.title ? ' title="' + i(t.title) + '"' : "") + ">" + this.output(e[1]) + "</a>" : '<img src="' + i(t.href) + '" alt="' + i(e[1]) + '"' + (t.title ? ' title="' + i(t.title) + '"' : "") + ">"
    }
    ,
    ...
    n.prototype.tok = function() {
        ...
        case "code":
            if (this.options.highlight) {
                ...
                null != e && e !== this.token.text && (this.token.escaped = !0,
                this.token.text = e)
            }
            return this.token.escaped || (this.token.text = i(this.token.text, !0)),
        ...
        case "table":
            ...
            n = 0; n < this.token.header.length; n++)
                ...
                a += this.token.align[n] ? '<th align="' + this.token.align[n] + '">' + t + "</th>\n" : "<th>" + t + "</th>\n";
            for (a += "</tr>\n</thead>\n",
            a += "<tbody>\n",
            n = 0; n < this.token.cells.length; n++) {
                ...
                a += "<tr>\n",
                s = 0; s < r.length; s++)
                    o = this.inline.output(r[s]),
                    a += this.token.align[s] ? '<td align="' + this.token.align[s] + '">' + o + "</td>\n" : "<td>" + o + "</td>\n";
                a += "</tr>\n"
            }
            return a += "</tbody>\n",
            "<table>\n" + a + "</table>\n";
        case "blockquote_start":
            ...
            return "<blockquote>\n" + a + "</blockquote>\n";
        case "list_start":
            for (var l = this.token.ordered ? "ol" : "ul", a = ""; "list_end" !== this.next().type; )
                a += this.tok();
            return "<" + l + ">\n" + a + "</" + l + ">\n";
...
function(e) {
    var t = e.app = {
        init: function() {
            ...
            t.showLoadingModal = function(e) {
                e = e || {},
                e.text = e.text || "",
                t.modal = new t.LoadingModalView,
                t.modal.setElement($("#menu-overlay")).render({
                    msg: e.text
                })
            }
            ,
            t.showLoginModal = function() {
                t.modal = new t.LoginView,
                t.modal.setElement($("#menu-overlay")).render()
            }
            ,
            t.router = new t.Router,
            Backbone.history.start()
        },
        modal: null
    }
      , n = navigator.userAgent.toLowerCase();
    t.mobile_agent = n.indexOf("mobi") > -1,
    t.is_android = n.indexOf("android") > -1,
    $(t.init)
}(window),
function(e) {
...
function(e) {
    e.NavbarView = e.View.extend({
        initialize: function() {
            this.template || (e.NavbarView.prototype.template = this.template || _.template($("#navbar-template").html()))
        },
        render: function() {
            return this.$el.html(this.template({
                subtext: "Nube de Aprendizaje Portátil"
            })),
...
function(e) {
    e.LoginBoxView = e.View.extend({
        events: {
            "click #login-btn": "buttonPress",
            "click #register-btn": "buttonPress"
        },
        initialize: function() {
            this.template || (e.LoginBoxView.prototype.template = this.template || _.template($("#loginBox-template").html()))
        },
        render: function() {
            return this.$el.html(this.template({
                loggedIn: !1
        ...
        buttonPress: function(t) {
            var n = t.target.id;
            "login-btn" == n && e.showLoginModal()
        }
    })
}(app),
function(e) {
    e.LoginView = e.View.extend({
        initialize: function() {
            this.template || (e.LoginView.prototype.template = this.template || _.template($("#login-template").html()))
        },
        render: function() {
            return this.$el.html(this.template()),
...
function(e) {
    e.SidebarView = e.View.extend({
        events: {},
        initialize: function() {
            this.template || (e.SidebarView.prototype.template = this.template || _.template($("#sidebar-template").html()))
        },
        render: function() {
            return this.$el.html(this.template()),
...
function(e) {
    function t(e) {
        e.hideAddressBar = function() {
            window.location.hash || (document.height < window.outerHeight && (document.body.style.height = window.outerHeight + 50 + "px"),
            setTimeout(function() {
                window.scrollTo(0, 1)
            }, 50))
        }
        ...
        window.addEventListener("load", function() {
            window.pageYOffset || e.hideAddressBar()
        }),
        window.addEventListener("orientationchange", e.hideAddressBar)
    }
    function n() {
        "ace"in window || (window.ace = {}),
        ace.handle_side_menu = function(e) {
            e("#menu-toggler").on(ace.click_event, function() {
                return e("#sidebar").toggleClass("display"),
                e(this).toggleClass("display"),
                !1
            });
            var t = e("#sidebar").hasClass("menu-min");
            e("#sidebar-collapse").on(ace.click_event, function() {
                t = e("#sidebar").hasClass("menu-min"),
                ace.settings.sidebar_collapsed(!t)
            }),
            e(".nav-list").on(ace.click_event, function(n) {
                var i = e(n.target).closest("a");
                if (i && 0 != i.length) {
                    if (t = e("#sidebar").hasClass("menu-min"),
                    i.hasClass("dropdown-toggle")) {
                        var r = i.next().get(0);
                        if (!e(r).is(":visible")) {
                            var o = e(r.parentNode).closest("ul");
                            if (t && o.hasClass("nav-list"))
                                return;
                            o.find("> .open > .submenu").each(function() {
                                this == r || e(this.parentNode).hasClass("active") || e(this).slideUp(200).parent().removeClass("open")
                            })
                        }
                        return t && e(r.parentNode.parentNode).hasClass("nav-list") ? !1 : (e(r).slideToggle(200).parent().toggleClass("open"),
                        !1)
                    }
                    if (t && "tap" == ace.click_event && i.get(0).parentNode.parentNode == this) {
                        var s = i.find(".menu-text").get(0);
                        if (n.target != s && !e.contains(s, n.target))
                            return !1
                    }
                }
            })
        ...
        ace.general_things = function(e) {
            e('.ace-nav [class*="icon-animated-"]').closest("a").on("click", function() {
                var t = e(this).find('[class*="icon-animated-"]').eq(0)
                  , n = t.attr("class").match(/icon\-animated\-([\d\w]+)/);
                t.removeClass(n[0]),
                e(this).off("click")
            })
        }
        ,
        jQuery(function(e) {
            window.ace.click_event = e.fn.tap ? "tap" : "click"
        }),
        jQuery(function() {
    ...
    e.MainView = e.View.extend({
        initialize: function() {
            return this
        },
        render: function(i) {
            return i = i || {},
            i.content && (this.content = i.content),
            0 != i.content && void 0 != i.content && (logger.info("Rendering app content"),
            this.content.setElement(this.$("#app-content")).render()),
            this.navbar || (logger.info("Rendering app navbar"),
            this.navbar = new e.NavbarView,
            this.navbar.setElement(this.$("#app-header")).render()),
            this.sidebar || (logger.info("Rendering app sidebar"),
            this.sidebar = new e.SidebarView,
...
function(e) {
    e.LoadingModalView = e.View.extend({
        initialize: function() {
            this.template || (e.LoadingModalView.prototype.template = this.template || _.template($("#loadingModal-template").html()))
        },
        events: {},
        render: function(e) {
            return this.$el.html(this.template({
...
function(e) {
    var t = !1
      , n = "assets/img/";
    e.HomeView = e.View.extend({
        initialize: function() {
            this.template || (e.HomeView.prototype.template = this.template || _.template($("#home-template").html())),
            this.apps = [],
            this.apps.push({
                title: "Smile",
                id: "smile",
                image: n + "smile_grey.png",
                description: "SMILE convierte un aula tradicional en un ambiente de aprendizaje altamente interactivo. Involucra la participación de los estudiantes, su razonamiento crítico y su habilidad de resolver problemas. Les permite generar, compartir y evaluar preguntas con multimedia."
            }),
            this.apps.push({
                title: "Wikipedia",
                id: "wikipedia",
                image: n + "wikipedia.png",
                description: "Wikipedia es una enciclopedia libre, editada colaborativamente."
            }),
            this.apps.push({
                title: "KA-Lite",
                id: "khan",
                image: n + "khan_academy.png",
                description: "KA Lite permite oportunidades de aprendizaje semipresencial utilizando los ejercicios de matemáticas de Khan Academy."
            }),
            this.apps.push({
                title: "Biblia para Niños",
                id: "bibleforchildren",
                image: n + "biblia-para-ninos.png",
                description: "Historias coloridas de la Biblia."
            }),
            this.apps.push({
                title: "Edify Dibujar y Pintar",
                id: "paint",
                image: n + "edify-dibujar-y-pintar.png",
                description: "Crea tus propios dibujos y pinturas electronicos!"
            }),
            this.apps.push({
                title: "Project Gutenberg",
                id: "gutenberg",
                image: n + "gutenberg.png",
                description: "Libros en español para leer y aprender!"
            }),
            this.apps.push({
                title: "Santa Biblia",
                id: "bible",
                image: n + "santa-biblia.png",
                description: "La Biblia es el relato de la acción de Dios en el mundo, y su propósito con toda la creación."
            }),
            this.apps.push({
                title: "Blockly Games",
                id: "blocklygames",
                image: n + "blockly-games.png",
                description: "Juegos para los programadores del futuro."
            }),
            this.apps.push({
                title: "Snap!",
                id: "snap",
                image: n + "snap-byob.png",
                description: "Snap! es una aplicación dey un lenguaje de programación visual."
            }),
            this.apps.push({
                title: "PhET Simulaciones Interactivas",
                id: "phet",
                image: n + "phet-interactive-sims.png",
                description: "Simulaciones educativos que cubren una variadad de materias diseñadas por la Universidad de Colorado."
            }),
            this.apps.push({
                title: "Typing Tutor",
                id: "typing",
                image: n + "open10fingers-typing.png",
                description: "Aprender y practicar habilidades con el teclado utilizando un tutor de un teclado colorido."
            }),
            this.apps.push({
                title: "1001 Stories Project Bookshelf",
                id: "soebookshelf",
                image: n + "soe-bookshelf.png",
                description: "[Inglés] Children love to tell stories. However, in many places in the world, their creative voices are rarely heard or cultivated. The 1001 Stories Program conducts storytelling workshops that build on children’s natural potential to become original storytellers."
            }),
            this.apps.push({
                title: "Childrens Books",
                id: "childrensbook",
                image: n + "childrens-books.png",
                description: "[Inglés] Colorful, free books for children (from Project Gutenberg) in PDF format."
            }),
            this.apps.push({
                title: "CK12",
                id: "ck12",
                image: n + "ck12.png",
                description: "[Inglés] High quality and curated Textbooks collection on STEM (Science, Technology, Engineering and Math) from ck12.org. PDF format."
            })
        },
        events: {
        ...
        closeButton: function(e) {
            ...
            logger.info("closed: " + i.className),
            $(i).remove(),
            t = !1
        },
        buttonPress: function(e) {
            var t = e.target.getAttribute("data-app-id");
            "smile" == t ? (logger.info("navigating to app smile"),
            window.location = window.location.origin + "/smile/") : "wikipedia" == t ? (logger.info("navigating to wikipeda"),
            window.location = window.location.origin + ":8001/") : "khan" == t ? (logger.info("navigating to khan"),
            window.location = window.location.origin + ":8008/") : "bible" == t ? (logger.info("navigating to bible"),
            window.location = window.location.origin + "/bible_es/") : "bibleforchildren" == t ? (logger.info("navigating to bibleforchildren"),
            window.location = window.location.origin + "/bible_for_children_es/") : "paint" == t ? (logger.info("navigating to paint"),
            window.location = window.location.origin + "/paint_es/") : "gutenberg" == t ? (logger.info("navigating to gutenberg"),
            window.location = window.location.origin + "/gutenberg/") : "snap" == t ? (logger.info("navigating to snap"),
            window.location = window.location.origin + "/snap/snap.html") : "blocklygames" == t ? (logger.info("navigating to blocklygames"),
            window.location = window.location.origin + "/blockly-games-es") : "phet" == t ? (logger.info("navigating to phet"),
            window.location = window.location.origin + "/phet_es/") : "typing" == t ? (logger.info("navigating to typing"),
            window.location = window.location.origin + "/open10fingers/") : "ck12" == t ? (logger.info("navigating to ck12"),
            window.location = window.location.origin + "/ck12/") : "childrensbook" == t ? (logger.info("navigating to childrensbook"),
            window.location = window.location.origin + "/childrens-books/") : "soebookshelf" == t && (logger.info("navigating to soebookshelf"),
...
function(e) {
    e.UsbView = e.View.extend({
        initialize: function() {
            this.template || (e.UsbView.prototype.template = this.template || _.template($("#usb-template").html()))
        },
        events: {
        ...
        tabClick: function(e) {
            ...
            "storage1-btn" == t ? ($("#storage1-tab").addClass("active"),
            $("#storage1-btn").addClass("active")) : "storage2-btn" == t && ($("#storage2-tab").addClass("active"),
            $("#storage2-btn").addClass("active"))
        },
        btnClick: function(t) {
            var n = t.target.id;
            "storage1-btn" == n ? (logger.info("navigating to storage1"),
            e.showLoadingModal({
                text: "Loading /storage1"
            }),
            window.location = "/storage1") : "storage2-btn" == n && (e.showLoadingModal({
                text: "Loading /storage2"
            }),
...
function(e) {
    e.AboutView = e.View.extend({
        initialize: function() {
            this.template || (e.AboutView.prototype.template = this.template || _.template($("#about-template").html()))
        },
        render: function() {
            return this.$el.html(this.template()),
...
function(e) {
    e.AdminView = e.View.extend({
        initialize: function() {
            this.template || (e.AdminView.prototype.template = this.template || _.template($("#admin-template").html()))
        },
        render: function() {
            return this.$el.html(this.template()),
        ...
        events: {
            "click #shutdown_button": "shutdown",
            "click #reboot_button": "reboot"
        },
        shutdown: function() {
            var e = new XMLHttpRequest;
            e.onreadystatechange = function() {
                4 == this.readyState && 200 == this.status && (document.getElementById("shutdown_button").innerHTML = "Shutting Down...")
            }
            ,
            e.open("GET", "/assets/shutdown.php", !0),
            e.send()
        },
        reboot: function() {
            var e = new XMLHttpRequest;
            e.onreadystatechange = function() {
                4 == this.readyState && 200 == this.status && (document.getElementById("reboot_button").innerHTML = "Rebooting...")
            }
            ,
            e.open("GET", "/assets/reboot.php", !0),
            e.send()
        }
    })
}(app),
function(e) {
    e.Router = Backbone.Router.extend({
        ...
        about: function() {
            this.setContentView({
                name: "about",
                view: new e.AboutView
            })
        },
        admin: function() {
            this.setContentView({
                name: "admin",
                view: new e.AdminView
            })
        },
        catchall: function() {
            logger.info("catchall"),
            "undefined" == typeof this.currentView && (logger.info(typeof this.currentView),
            this.navigate("", {
                trigger: !0,
                replace: !0
            }))
        },
        setContentView: function(t) {
            t = t || {};
            var n = t.name
              , i = t.view;
            this.content = i,
            this.content && this.content.view && this.content.view.remove(),
            null == this.mainView ? (this.mainView = new e.MainView({
                id: "app-container"
            }),
            this.mainView.setElement($("#app-container")).render({
                content: this.content
            })) : this.content && this.mainView.setElement($("#app-container")).render({
                content: this.content
            }),
            n && ($(".nav li").removeClass("active"),
...
// Copyright 2013 SMILE Consortium
